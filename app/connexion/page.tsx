      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "Cette plateforme m'a permis de rencontrer des professionnels talentueux et de concrétiser mes projets artistiques."
            </p>
            <footer className="text-sm">Sofia Diallo</footer>
          </blockquote>
        </div>
      </div>
